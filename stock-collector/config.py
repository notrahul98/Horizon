...
_NIFTY_150_SYMBOLS = [
    ...
    "JSWSTEEL.NS", "COALINDIA.NS", "TMPV.NS", "ADANIPORTS.NS", "NESTLEIND.NS",
    ...
    # NIFTY NEXT 50
    "PAYTM.NS", "ETERNAL.NS", "AMBUJACEM.NS", "PIDILITIND.NS", "GODREJCP.NS",
    "SIEMENS.NS", "DMART.NS", "ADANIPOWER.NS", "DLF.NS", "DABUR.NS",
    "HDFCAMC.NS", "VEDL.NS", "SHREECEM.NS", "TORNTPHARM.NS", "GAIL.NS",
    "CHOLAFIN.NS", "UNITDSPR.NS", "PAGEIND.NS", "ICICIGI.NS", "ABB.NS",
    ...
    "ATGL.NS", "BOSCHLTD.NS", "HAVELLS.NS", "NAUKRI.NS", "AUROPHARMA.NS",
    "PFC.NS", "RECLTD.NS", "UNIONBANK.NS", "MRF.NS", "INDHOTEL.NS",
    # NIFTY MIDCAP 50
    "ALOKINDS.NS", "ASHOKLEY.NS", "BATAINDIA.NS", "BEL.NS", "CUMMINSIND.NS",
    "ESCORTS.NS", "EXIDEIND.NS", "FEDERALBNK.NS", "GMRAIRPORT.NS", "GODREJIND.NS",
    ...
    "TVSMOTOR.NS", "WHIRLPOOL.NS", "YESBANK.NS", "ZEEL.NS", "GLAND.NS",
    ...
    # Added to round the list out to a true 150 unique symbols (see replit.md Gotchas
    # for the ticker-rename fixes above this line)
    "TMCV.NS", "VBL.NS", "DIXON.NS", "MARICO.NS", "POLICYBZR.NS",
]
